...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\MY PC\PycharmProjects\Inmakes Learning\demoproject\venv\Scripts\python'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\MY PC\PycharmProjects\Inmakes Learning\demoproject\venv\Scripts\python\Scripts\deactivate.nu'
